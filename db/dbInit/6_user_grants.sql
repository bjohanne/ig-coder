...
GRANT EXECUTE ON PROCEDURE `mgmt`.`create_document` TO 'user'@'%';
GRANT EXECUTE ON PROCEDURE `mgmt`.`create_document_member_permission` TO 'user'@'%';
GRANT EXECUTE ON PROCEDURE `mgmt`.`create_document_user_permission` TO 'user'@'%';
...
GRANT EXECUTE ON PROCEDURE `mgmt`.`delete_document` TO 'user'@'%';
GRANT EXECUTE ON PROCEDURE `mgmt`.`delete_document_member_permission` TO 'user'@'%';
GRANT EXECUTE ON PROCEDURE `mgmt`.`delete_document_user_permission` TO 'user'@'%';
...
GRANT EXECUTE ON PROCEDURE `mgmt`.`read_all_documents_of_project` TO 'user'@'%';
...
GRANT EXECUTE ON PROCEDURE `mgmt`.`read_all_statements_of_document` TO 'user'@'%';
GRANT EXECUTE ON PROCEDURE `mgmt`.`read_all_versions_of_statement` TO 'user'@'%';
GRANT EXECUTE ON PROCEDURE `mgmt`.`read_document` TO 'user'@'%';
GRANT EXECUTE ON PROCEDURE `mgmt`.`read_project` TO 'user'@'%';
GRANT EXECUTE ON PROCEDURE `mgmt`.`update_document` TO 'user'@'%';
