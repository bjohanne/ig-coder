        ...
        <div className="navbar-collapse collapse w-100 order-3 dual-collapse2">
            <ul className="navbar-nav ml-auto">
                <li className="nav-item">
                    <a className="nav-link" href="#/" onClick={() => {}}>Home</a>
                </li>
                <li className="nav-item">
                    <a className="nav-link" href="#/" onClick={() => {}}>About</a>
                </li>
                <li className="nav-item">
                    <a className="nav-link" href="#/" onClick={() => {}}>Features</a>
                </li>
                <li className="nav-item">
                    <a className="nav-link" href="#/" onClick={() => {}}>Contact</a>
                </li>
            </ul>
