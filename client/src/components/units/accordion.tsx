...
const Accordion = (props: any) => {
    ...
    const save = () => {
        ...
        let payload = { documentId: props.documentId, content: entryContent };
        console.log(payload);
    ...
    const RenderAccordion = () => {
        ...
        <div className="accordion__section">
            ...
            <div ref={content} style={{ maxHeight: `${setHeight}` }} className="accordion__content">
                ...
                { !props.content &&
                <textarea value={entryContent} onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => handleInputChange(e)} className="new-entry-text-area" />
