  ...
  */
    ...
    <div className="card mx-auto" style={{maxWidth: 800 + "px"}}>
        <div className="card-body p-5 text-center">
            ...
            <input type="text" className="form-control" name="name" placeholder="Document Name" required value={form.name} onChange={updateField}/>            
            </div>
            <div className="form-group">
            <textarea className="form-control" rows={6} name="description" placeholder="Document Description" value={form.description} onChange={updateField}></textarea>
            </div>
