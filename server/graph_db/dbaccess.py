        ...
        for item in nodes:
            ...
            if "children" in item:
                for child in item["children"]:
                    ...
                    statements.append("MERGE (Document{4}{0})-[:child_of]->(Document{4}{1})"
                                      .format(child["id"], item["id"], child["nodeType"],
                                              item["nodeType"], item["document"]))
                del item["children"]
            ...
            statements.insert(0, """ MERGE (Document{0}{1}:{2} {3}) ON CREATE SET Document{0}{1}.createdAt = '{4}' ON MATCH SET Document{0}{1}.updatedAt = '{4}' """
                              .format(item["document"], item["id"], item["nodeType"], "{" + dict_args + "}", now_str))
